...
\begin{enumerate}[(a)]
    ...
    \item \textbf{(15 pts) Batch Verification via Univariate Polynomials.}
    ...
    \item \textbf{(25 pts) The Protocol.}
    
    Show that you can construct another univariate polynomial $Q_A(u)$ such that $Q_A(i)$ equals $P_A(b_i)$ for all $i \in [n]$, and $Q_A(x)$ can be computed in $\tilde{O}(n \cdot \poly(d))$ time.
